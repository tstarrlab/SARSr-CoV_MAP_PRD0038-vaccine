...
```{r hist_n_bc_per_mutant, fig.width=8, fig.height=9, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(3,2))
...
```{r plot_expression, echo=T, fig.width=6, fig.height=18, fig.align="center", dpi=300,dev="png"}
par(mfrow=c(6,2))
...
```{r derive_norm_AUC, echo=T, fig.width=8, fig.height=12, fig.align="center", dpi=300,dev="png"}
...
```
Normalization coefficients were: mouse1.3 `r lm_mouse1.3$coefficients[2]`, mouse1.4 `r lm_mouse1.4$coefficients[2]`, mouse1.5 `r lm_mouse1.5$coefficients[2]`, mouse1.6 `r lm_mouse1.6$coefficients[2]`, mouse2.3 `r lm_mouse2.3$coefficients[2]`, and mouse2.6 `r lm_mouse2.6$coefficients[2]`, 
...
```
Make heatmaps faceted by target, showing raw AUC and delta-AUC of muts relative to respective wildtype

First, mouse1.3 sera

```{r heatmap_DMS_AUC-by-target_mouse1.3-sera, fig.width=25,fig.height=12,fig.align="center", dpi=500,dev="png",echo=T}
...
Same but illustrating delta_AUC by target (each delta noramlized to its wt background), for mouse1.3 sera.

```{r heatmap_DMS_delta-AUC-by-target_mouse1.3-sera, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
Same but illustrating delta_normAUC (expression-normalized+censored) by target (each delta noramlized to its wt background), for mouse1.3 sera.

```{r heatmap_DMS_delta-normAUC-by-target_mouse1.3-sera, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
```{r heatmap_DMS_AUC-by-target_mouse1.4-sera, fig.width=25,fig.height=12,fig.align="center", dpi=500,dev="png",echo=T}
...
Same but illustrating delta_AUC by target (each delta noramlized to its wt background), for mouse1.4 sera.

```{r heatmap_DMS_delta-AUC-by-target_mouse1.4-sera, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
Same but illustrating delta_normAUC (expression-normalized+censored) by target (each delta noramlized to its wt background), for mouse1.4 sera.

```{r heatmap_DMS_delta-normAUC-by-target_mouse1.4-sera, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
```{r heatmap_DMS_AUC-by-target_mouse1.5-sera, fig.width=25,fig.height=12,fig.align="center", dpi=500,dev="png",echo=T}
...
Same but illustrating delta_AUC by target (each delta noramlized to its wt background), for mouse1.5 sera.

```{r heatmap_DMS_delta-AUC-by-target_mouse1.5-sera, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
Same but illustrating delta_normAUC (expression-normalized+censored) by target (each delta noramlized to its wt background), for mouse1.5 sera.

```{r heatmap_DMS_delta-normAUC-by-target_mouse1.5-sera, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
```{r heatmap_DMS_AUC-by-target_mouse1.6-sera, fig.width=25,fig.height=12,fig.align="center", dpi=500,dev="png",echo=T}
...
Same but illustrating delta_AUC by target (each delta noramlized to its wt background), for mouse1.6 sera.

```{r heatmap_DMS_delta-AUC-by-target_mouse1.6-sera, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
Same but illustrating delta_normAUC (expression-normalized+censored) by target (each delta noramlized to its wt background), for mouse1.6 sera.

```{r heatmap_DMS_delta-normAUC-by-target_mouse1.6-sera, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
```{r heatmap_DMS_AUC-by-target_mouse2.3-sera, fig.width=25,fig.height=12,fig.align="center", dpi=500,dev="png",echo=T}
...
Same but illustrating delta_AUC by target (each delta noramlized to its wt background), for mouse2.3 sera.

```{r heatmap_DMS_delta-AUC-by-target_mouse2.3-sera, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
Same but illustrating delta_normAUC (expression-normalized+censored) by target (each delta noramlized to its wt background), for mouse2.3 sera.

```{r heatmap_DMS_delta-normAUC-by-target_mouse2.3-sera, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
```{r heatmap_DMS_AUC-by-target_mouse2.6-sera, fig.width=25,fig.height=12,fig.align="center", dpi=500,dev="png",echo=T}
...
Same but illustrating delta_AUC by target (each delta noramlized to its wt background), for mouse2.6 sera.

```{r heatmap_DMS_delta-AUC-by-target_mouse2.6-sera, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
Same but illustrating delta_normAUC (expression-normalized+censored) by target (each delta noramlized to its wt background), for mouse2.6 sera.

```{r heatmap_DMS_delta-normAUC-by-target_mouse2.6-sera, fig.width=25,fig.height=15,fig.align="center", dpi=500,dev="png",echo=T}
...
```{r heatmap_DMS_AUC-by-sera_SARS-CoV-2_WH1, fig.width=25,fig.height=18,fig.align="center", dpi=500,dev="png",echo=T}
...
```{r heatmap_DMS_delta-AUC-by-sera_SARS-CoV-2_WH1, fig.width=25,fig.height=18,fig.align="center", dpi=500,dev="png",echo=T}
...
```{r heatmap_DMS_delta-normAUC-by-sera_SARS-CoV-2_WH1, fig.width=25,fig.height=18,fig.align="center", dpi=500,dev="png",echo=T}
...
```{r heatmap_DMS_AUC-by-sera_SARS-CoV-2_BA2, fig.width=25,fig.height=18,fig.align="center", dpi=500,dev="png",echo=T}
temp1 <- temp[measurement %in% c("mouse1.3_AUC","mouse1.4_AUC","mouse1.5_AUC","mouse1.6_AUC","mouse2.3_AUC","mouse2.6_AUC")]
temp1$measurement <- factor(temp1$measurement,levels=c("mouse1.4_AUC","mouse1.6_AUC","mouse1.3_AUC","mouse1.5_AUC","mouse2.3_AUC","mouse2.6_AUC"))
...
Same but illustrating delta_AUC by sera (each delta noramlized to its wt background), for SARS-CoV-2_BA2

```{r heatmap_DMS_delta-AUC-by-sera_SARS-CoV-2_BA2, fig.width=25,fig.height=18,fig.align="center", dpi=500,dev="png",echo=T}
temp2 <- temp[measurement %in% c("delta_mouse1.3_AUC","delta_mouse1.4_AUC","delta_mouse1.5_AUC","delta_mouse1.6_AUC","delta_mouse2.3_AUC","delta_mouse2.6_AUC")]
temp2$measurement <- factor(temp2$measurement,levels=c("delta_mouse1.4_AUC","delta_mouse1.6_AUC","delta_mouse1.3_AUC","delta_mouse1.5_AUC","delta_mouse2.3_AUC","delta_mouse2.6_AUC"))
...
Same but illustrating delta_normAUC by sera (expresion-norm/cens, each delta noramlized to its wt background), for SARS-CoV-2_BA2

```{r heatmap_DMS_delta-normAUC-by-sera_SARS-CoV-2_BA2, fig.width=25,fig.height=18,fig.align="center", dpi=500,dev="png",echo=T}
temp3 <- temp[measurement %in% c("delta_mouse1.3_normAUC","delta_mouse1.4_normAUC","delta_mouse1.5_normAUC","delta_mouse1.6_normAUC","delta_mouse2.3_normAUC","delta_mouse2.6_normAUC")]
temp3$measurement <- factor(temp3$measurement,levels=c("delta_mouse1.4_normAUC","delta_mouse1.6_normAUC","delta_mouse1.3_normAUC","delta_mouse1.5_normAUC","delta_mouse2.3_normAUC","delta_mouse2.6_normAUC"))
...
```{r heatmap_DMS_AUC-by-sera_SARS-CoV-1_Urbani, fig.width=25,fig.height=18,fig.align="center", dpi=500,dev="png",echo=T}
temp1 <- temp[measurement %in% c("mouse1.3_AUC","mouse1.4_AUC","mouse1.5_AUC","mouse1.6_AUC","mouse2.3_AUC","mouse2.6_AUC")]
temp1$measurement <- factor(temp1$measurement,levels=c("mouse1.4_AUC","mouse1.6_AUC","mouse1.3_AUC","mouse1.5_AUC","mouse2.3_AUC","mouse2.6_AUC"))
...
```{r heatmap_DMS_delta-AUC-by-sera_SARS-CoV-1_Urbani, fig.width=25,fig.height=18,fig.align="center", dpi=500,dev="png",echo=T}
temp2 <- temp[measurement %in% c("delta_mouse1.3_AUC","delta_mouse1.4_AUC","delta_mouse1.5_AUC","delta_mouse1.6_AUC","delta_mouse2.3_AUC","delta_mouse2.6_AUC")]
temp2$measurement <- factor(temp2$measurement,levels=c("delta_mouse1.4_AUC","delta_mouse1.6_AUC","delta_mouse1.3_AUC","delta_mouse1.5_AUC","delta_mouse2.3_AUC","delta_mouse2.6_AUC"))
...
```{r heatmap_DMS_delta-normAUC-by-sera_SARS-CoV-1_Urbani, fig.width=25,fig.height=18,fig.align="center", dpi=500,dev="png",echo=T}
temp3 <- temp[measurement %in% c("delta_mouse1.3_normAUC","delta_mouse1.4_normAUC","delta_mouse1.5_normAUC","delta_mouse1.6_normAUC","delta_mouse2.3_normAUC","delta_mouse2.6_normAUC")]
temp3$measurement <- factor(temp3$measurement,levels=c("delta_mouse1.4_normAUC","delta_mouse1.6_normAUC","delta_mouse1.3_normAUC","delta_mouse1.5_normAUC","delta_mouse2.3_normAUC","delta_mouse2.6_normAUC"))
...
```{r heatmap_DMS_AUC-by-sera_PRD-0038, fig.width=25,fig.height=18,fig.align="center", dpi=500,dev="png",echo=T}
temp1 <- temp[measurement %in% c("mouse1.3_AUC","mouse1.4_AUC","mouse1.5_AUC","mouse1.6_AUC","mouse2.3_AUC","mouse2.6_AUC")]
temp1$measurement <- factor(temp1$measurement,levels=c("mouse1.4_AUC","mouse1.6_AUC","mouse1.3_AUC","mouse1.5_AUC","mouse2.3_AUC","mouse2.6_AUC"))
...
```{r heatmap_DMS_delta-AUC-by-sera_PRD-0038, fig.width=25,fig.height=18,fig.align="center", dpi=500,dev="png",echo=T}
temp2 <- temp[measurement %in% c("delta_mouse1.3_AUC","delta_mouse1.4_AUC","delta_mouse1.5_AUC","delta_mouse1.6_AUC","delta_mouse2.3_AUC","delta_mouse2.6_AUC")]
temp2$measurement <- factor(temp2$measurement,levels=c("delta_mouse1.4_AUC","delta_mouse1.6_AUC","delta_mouse1.3_AUC","delta_mouse1.5_AUC","delta_mouse2.3_AUC","delta_mouse2.6_AUC"))
...
```{r heatmap_DMS_delta-normAUC-by-sera_PRD-0038, fig.width=25,fig.height=18,fig.align="center", dpi=500,dev="png",echo=T}
temp3 <- temp[measurement %in% c("delta_mouse1.3_normAUC","delta_mouse1.4_normAUC","delta_mouse1.5_normAUC","delta_mouse1.6_normAUC","delta_mouse2.3_normAUC","delta_mouse2.6_normAUC")]
temp3$measurement <- factor(temp3$measurement,levels=c("delta_mouse1.4_normAUC","delta_mouse1.6_normAUC","delta_mouse1.3_normAUC","delta_mouse1.5_normAUC","delta_mouse2.3_normAUC","delta_mouse2.6_normAUC"))
